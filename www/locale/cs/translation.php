...
define("DOG_TABLE_HEADER_OWNER", 'majitel');
...
define("DOG_FORM_OLD_OWNER_DELETE", 'Smazat předchozího majitele');
define("DOG_FORM_OLD_OWNER_TITLE", 'Smazání předchozího majitele');
define("DOG_FORM_OLD_OWNER_INFO", 'Opravdu smazat předchozího majitele?');
define("DOG_FORM_OLD_OWNER_DELETED", 'Předchozí majitel smazán.');
define("DOG_FORM_OLD_OWNER_FAILED", 'Předchozího majitele se nepodařilo smazat!');
