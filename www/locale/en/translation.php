...
define("BLOCK_SETTINGS_ITEM_GDPR_BLOCK", "This block cannot be deleted bacause it is about GDPR information.");
...
define("DOG_TABLE_HEADER_OWNER", 'owner');
...
define("DOG_FORM_OLD_OWNER_DELETE", 'Delete previous owner');
define("DOG_FORM_OLD_OWNER_TITLE", 'Previous owner delete');
define("DOG_FORM_OLD_OWNER_INFO", 'Are you really wnat to delete the previous owner?');
define("DOG_FORM_OLD_OWNER_DELETED", 'Previous owner has been deleted.');
define("DOG_FORM_OLD_OWNER_FAILED", 'Previous owner delete failed!');
