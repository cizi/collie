...
class DogEntity {
	...
	public function hydrate(array $data) {
		$this->setID($data['ID']);
		$this->setTitulyPredJmenem($data['TitulyPredJmenem']);
		$this->setTitulyZaJmenem($data['TitulyZaJmenem']);
		$this->setJmeno($data['Jmeno']);
		$this->setDatNarozeni($data['DatNarozeni']);
		$this->setDatUmrti($data['DatUmrti']);
		$this->setUmrtiKomentar($data['UmrtiKomentar']);
		$this->setPohlavi($data['Pohlavi']);
		$this->setPlemeno($data['Plemeno']);
		$this->setBarva($data['Barva']);
		$this->setSrst($data['Srst']);
		$this->setBarvaKomentar($data['BarvaKomentar']);
		$this->setCisloZapisu($data['CisloZapisu']);
		$this->setPCisloZapisu($data['PCisloZapisu']);
		$this->setCip($data['Cip']);
		$this->setTetovani($data['Tetovani']);
		$this->setZdravotniKomentar($data['ZdravotniKomentar']);
		$this->setVarlata($data['Varlata']);
		$this->setSkus($data['Skus']);
		$this->setZuby($data['Zuby']);
		$this->setZubyKomentar($data['ZubyKomentar']);
		$this->setChovnost($data['Chovnost']);
		$this->setChovnyKomentar($data['ChovnyKomentar']);
		$this->setPosudek($data['Posudek']);
		$this->setZkousky($data['Zkousky']);
		$this->setTitulyKomentar($data['TitulyKomentar']);
		$this->setOceneni($data['Oceneni']);
		$this->setZavody($data['Zavody']);
		$this->setoID($data['oID']);
		$this->setmID($data['mID']);
		$this->setKomentar($data['Komentar']);
		$this->setPosledniZmena($data['PosledniZmena']);
		$this->setVyska($data['Vyska']);
		$this->setVaha($data['Vaha']);
		$this->setBonitace($data['Bonitace']);
		$this->setImpFrom($data['ImpFrom']);
		$this->setImpID($data['ImpID']);
		$this->setoIDupdate($data['oIDupdate']);
		$this->setmIDupdate($data['mIDupdate']);
	}
